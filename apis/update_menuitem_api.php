...
//เอาข้อมูลใส่ในตัวแปร base64 แปลงเป็นตัวรูปเก็บใน folder ที่กำหนด
$new_filname = 'menu_' . uniqid() . '.jpg';
file_put_contents('./../images/menuitem/' . $new_filname,  base64_decode($data->itemImage));
$menu_item->itemImage  = $new_filname;
...
$result = $menu_item->updateMenuItem();
